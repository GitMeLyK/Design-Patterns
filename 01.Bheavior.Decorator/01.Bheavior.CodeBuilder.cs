...
namespace DotNetDesignPatternDemos.Structural.Decorator.CodeBuilder2
{
    /*
     * In questo esempio ci comportiamo per il decoratore di fornire 
     * a differenza di prima che reimplementava rendendola fluente come 
     * interfaccia la stringbuilder e richiamandola come codebuilder,
     * qui facciamo in modo che l'intenzione finale riadattando l'oggetto
     * principale interno cioè lo StringBuilder con la possibilità di
     * interscambiarsi all'esterno con il MySringBuilder che è la nostra
     * personalizzazione di decoratore.
     * In questo esempio facciamo si che lo StringBuilder adotti la concatenzazione
     * di stringhe come nel caso di variabili a stringa che sono immutabili ma
     * hanno intrnsicamente il += che è un operatore che muta aggiungendo a destra
     * della stringa immutabile altri caratteri, e detta in parole povere arricchiamo
     * lo stringbuilder di avere la possibilità di concatenare e assumere lo stesso
     * comportamento del tipo string con operatore.
     */
    ...
    public class MyStringBuilder
    {
        ...
        // QUi abbiamo arricchito la conversione implicita a stringa
        // per permettere all'esterno l possibilità di concetanre.
    ...
    public class Demo
    {
        ...
        {
            // Ecco quindi che il costruttore potrà
            // in una singola riga accettare come parametro la conversione
            // da stringa al nostro stringbuilder
            MyStringBuilder s = "hello ";

            // e con l'adattatore che internamente usiamo per implementare
            // l'operatore + abbiamo anche dato la posibilità di concatenare
