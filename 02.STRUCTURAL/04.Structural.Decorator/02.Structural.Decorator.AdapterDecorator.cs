...
namespace DotNetDesignPatternDemos.Structural.Decorator.CodeBuilder
{
     ...
     * una classe che si occupa di fare cose simili allo stringbuilder
     * per assemblare stringhe prima di utilizzarle secondo una serie
     * di metodi come AppendLine Append etc, questa classe internamente
     * fornisce le funzinalità della classe sealed non ereditabile dello
     * stringbuilder e ne corregge il tiro per quello che ci serve e 
     * come deve essere diposto per il decoratore che stiamo fornendo
     * all'applcazione che ne vuole fare uso.
     * In questo caso abbiamo costuit un generatore di codice con modalità
     * fluente facendo restituire a tutti i metodi il this di contesto stesso.
     */
